...
export function Pricing() {
  ...
  // Check for plan querystring parameter on component mount
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (planParam) {
        const planName = planParam.toLowerCase();
        if (
          planName === "starter" ||
          planName === "investor" ||
          planName === "vip"
      ...
      if (periodParam && periodParam.toLowerCase() === "annually") {
        setActivePeriod("Annually");
      }
    }
  }, []);

  // Create plans array with dynamic featured property
  const dynamicPlans = plans.map((plan) => ({
    ...plan,
    featured: plan.name === selectedPlan,
  }));
